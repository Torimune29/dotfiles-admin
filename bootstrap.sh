...
sh -c "$(curl -fsLSk https://chezmoi.io/get)" -- init --apply --destination / --source /etc/chezmoi/data --config-path /etc/chezmoi/ --config-format toml https://github.com/Torimune29/dotfiles-admin.git
